			...
			public void actionPerformed(ActionEvent arg0) {
				...
				else
				{
					try {
						...
						pst2.execute();
						JOptionPane.showMessageDialog(null, "Amount Withdrawn successful! New balance is: " + UpdatedBalance);
						...
						dispose();
							...
							JOptionPane.showMessageDialog(null, "Not enough balance. Your total balance is: " + OldBalance);
						}
